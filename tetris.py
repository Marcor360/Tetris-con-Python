...
class Text:
    def __init__(self, app):
        self.app = app
        self.font = ft.Font(FONT_TEXT)

    def get_color(self):
        time = pg.time.get_ticks() * 0.0005
    ...
    def draw(self):
        self.font.render_to(self.app.screen, (WIN_W * 0.680, WIN_H * 0.02),
                            text='TETRIS', fgcolor=self.get_color(),
                            size=TILE_SIZE * 1.65)
        self.font.render_to(self.app.screen, (WIN_W * 0.65, WIN_H * 0.22),
                            text='SIGUIENTE:', fgcolor='white',
                            size=TILE_SIZE * 1.4)
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.67),
                            text='PUNTUACION:', fgcolor='white',
                            size=TILE_SIZE * 1.4)
        self.font.render_to(self.app.screen, (WIN_W * 0.80, WIN_H * 0.90),
                            text='RJV', fgcolor=self.Color_2(),
                            size=TILE_SIZE * .7)
...
class Tetris:
    def __init__(self, app):
        ...
        self.score = 0
        self.full_lines = 0
        self.points_per_lines = {0: 0, 1: 10, 2: 30, 3: 70, 4: 150, 5: 300} #Los puntos que se dan por combos
